...
# Define directories (absolute paths so scripts work from any CWD)
...
Hosts: Davis (Male, analytical, explains grammar) and Emma (Female, enthusiastic, provides vivid examples).
...
2. Heading: "Conversation 1 - The Bad Week"
   - A LONG roleplay (at least 15 turns) where Emma had a terrible week. Use advanced B2/C1 vocabulary (e.g., shattered, swamped, piling up, a drag, snowed under). Include a story about a missed deadline and traffic.
3. Heading: "The Breakdown: Analyzing the Bad Week"
   - Davis and Emma stop and dissect the roleplay. Explain the difference between ED and ING adjectives (e.g., stressful vs stressed). Explain the phrasal verbs used in deep detail (what does "piling up" literally mean?).
4. Heading: "Conversation 2 - The Winning Week"
   - A LONG roleplay (at least 15 turns) where Davis had an amazing week. Use vocabulary like (smooth sailing, on a roll, over the moon, paid off). Include a story about a successful presentation and a relaxing weekend.
...
6. Heading: "Mini-Game: Boring vs. Brilliant"
   - Davis gives 3 "Boring" textbook sentences (e.g., "I am very tired", "I am busy"). Emma upgrades them to "Brilliant" B2/C1 phrases (e.g., "Running on fumes", "Tied up"). Explain the mental image behind each phrase.
7. Heading: "Outro"
...
2. `text_tts`: Text optimized for the VibeVoice neural TTS engine to sound natural and expressive. Apply these rules ONLY to `text_tts`:
   - PUNCTUATION FOR PACING: Use commas `,`, ellipses `...`, or dashes `—` frequently mid-sentence to create natural pauses and thinking rhythm. Use `!` for excitement and `?` for rising intonation.
   - EMPHASIS VIA CAPITALIZATION: Write important words in ALL CAPS to make the TTS engine stress them. Examples: `REALLY`, `EXHAUSTING`, `HUGE`.
   - FILLER SOFTENING: Keep filler words lowercase and follow them with a comma for a lighter, faster delivery. Examples: `oh, wow`, `well, you know`, `right,`.
   - DO NOT use any special markup tags, brackets, or custom syntax. Only use standard English text with punctuation.
   Example: `"text_display": "Oh wow, I completely agree! My week was totally exhausting.", "text_tts": "oh, wow... I COMPLETELY agree! My week was TOTALLY exhausting."`
...
{{
  ...
  "script": [
    ...
    {{"type": "dialogue", "speaker": "Davis", "text_display": "Clean text for reading", "text_tts": "Text formatted with VibeVoice rules for speaking"}}
  ]
}}"""
